...
system_prompt = Template("\n".join([
    ...
    "استخدم فقط المعلومات الموجودة في المستندات المقدمة - لا تضف معرفة خارجية.",
    "إذا لم تحتوِ المستندات على معلومات كافية، اذكر هذا القيد بوضوح.",
]))
...
footer_prompt = Template("\n".join([
    "بناءً بدقة على المستندات المذكورة أعلاه، يرجى توليد إجابة للمستخدم.",
    "## السؤال:",
    "$query",
    "",
    "## الإجابة:",
